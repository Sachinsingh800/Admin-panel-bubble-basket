...
export default function Combining() {
  const containerWidth = window.innerWidth >= 400 ? 500 : 300;
  const containerHeight = window.innerWidth >= 400 ? 400 : 400;
  ...
  return (
    ...
    >
      ...
      <ChartsYAxis label="Customers" position="right" axisId="pib" />
    </ChartContainer>
  );
}
