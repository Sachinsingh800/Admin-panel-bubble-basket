    ...
    <div className={style.invoice_container}>
      ...
      <div className={style.shipping_billing}>
        ...
        <div className={style.shipping}>
          ...
          <div>
            <strong>
              NYKAA E-RETAIL LIMITED | GSTIN # : 07AAFCN5072P1ZX| FSSAI License
              No # : 10021011000081
            </strong>

            <p>
              Khasra no, 1226 Rajokari villageSouth WestNew Delhi, Delhi, INDIA
              - 110038
            </p>
          </div>
        </div>
        ...
        <div className={style.invoice_details_innerbox}>
          ...
          <div>
            ...
            <p>
              ...
              <span><strong> 1188.00</strong></span>
            </p>
          </div>
        </div>
      </div>
      <p>Refund amount due to difference between order MRP and shipment MRP INR 0</p>
      <div className={style.block}></div>
      <div>
        <p>Declaration I : Tax is not payable on reverse charge basis.</p>
        <p><strong>CUSTOMER SELF DECLARATION:</strong> I, Hereby confirm that the content of this package are being purchased for my internal and personal
purpose and not for resale. I further understand and agree to Nykaa's Terms and Conditions.</p>
      </div>
      <div className={style.block}></div>
